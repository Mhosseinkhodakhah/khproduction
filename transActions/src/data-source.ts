...
export const AppDataSource = new DataSource({
    ...
    synchronize: true,
    logging: false,
    entities: [User,Otp,Invoice,InvoiceType,Wallet,PaymentInfo,
        NotMatch,BankAccount,WalletTransaction,goldPrice,transPortQueue , 
        systemSetting,handleGoldPrice , EstimateTransactions , transportInvoice , productList , convertTradeInvoice , systemSetting , transActionQeue],
    migrations: [],
    subscribers: [],
})
