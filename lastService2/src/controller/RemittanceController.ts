...
export class RemittanceController {
    ...
    //             return next(new responseModel(req, res,'', 'create buy remmitance ', 500, "خطای داخلی سرویس", null))
    //         }
    //         if (resultFromLastService.response.status >= 500) {
    //             return next(new responseModel(req, res,'', 'create buy remmitance ', 500, "خطای داخلی سرویس", null))
    //         }
    ...
    //         return next(new responseModel(req, res,'', 'create buy remmitance ', 400 , "کاربر وجود ندارد", null))
    //     }
