...
export const AppDataSource = new DataSource({
    ...
    synchronize: true,
    logging: false,
    entities: [User,Otp,Invoice,InvoiceType,Wallet,PaymentInfo,NotMatch,BankAccount,WalletTransaction,goldPrice , EstimateTransactions,handleGoldPrice , transportInvoice , productList , convertTradeInvoice],
    migrations: [],
    subscribers: [],
})
