...
export default class logger{
    async addNewLog(user , title : string , description : string , action : {} , status : number):Promise<boolean>{
        try {
            let data = {
                user : user,
                title,
    ...
    async addNewAdminLog(user , title : string , description : string , action : {} , status : number):Promise<boolean>{
        try {
            let data = {
                user : user,
                title,
    ...
    // /**
    //  * this function is for checking oldUser existance
    //  * @param phoneNumber 
    //  * @param nationalCode 
    //  * @returns 
    //  */
